...
void InvertedIndexMergerThread<T>::excecuteMerge() {
    typename btree::btree_map<T,ProgramList*>::iterator it_list_i;
    typename btree::btree_map<T,ProgramList*>::iterator it_list_j;
    btree::btree_map<int,NodeInfo*>::iterator it_node_i;
    btree::btree_map<int,NodeInfo*>::iterator it_node_j;
    ...
    for(it_list_i=myself->TermIndex->begin();it_list_i!=myself->TermIndex->end();it_list_i++) {
        ...
        btree::btree_map<int,NodeInfo*> &tmp_hi=*it_list_i->second->nodeMap;
...
//        判断pointer_j是不是由于flag可能需要清空
        ...
        {
            btree::btree_map<int,NodeInfo*> &tmp_hj=*it_list_j->second->nodeMap;
