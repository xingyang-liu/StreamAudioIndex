...
//	long addTermSum=0;
//
//	ifstream info_in("/home/watson/C++/git_c-/Phonome/text_src/info_live2.txt");
//	if (!info_in) exit(7);
...
//		int TermSum =0;
//		btree::btree_map<string, double> TagsNum_tmp;
...
//	int length=0;
//	string str;
//	btree::btree_map<string,double>::iterator it=IdfTable.begin();
...
//	int sleeptime=fam.sleeptime;
//
//	ifstream file_tmp("/home/watson/C++/git_c-/Phonome/text_src/query_test.txt");
//	if(!file_tmp) exit(7);
//	vector<string> query_str_list;
//	srand((unsigned)time(NULL));
//	string str;
////	btree::btree_map<string,IdfCode>::iterator it=IdfTable.begin();
//	cout<<"Initialize List of Query."<<endl;
//	for (int i=0;i<times;i++)
//	{
...
//	//生成测试数组
//
//	ifstream file_in("/home/watson/C++/git_c-/Phonome/text_src/update_test.txt");
//	if(!file_in) exit(7);
//	string id_tmp;
//	string score_tmp;
//	btree::btree_map<int,double> test_update;
//	for (int i=0;i<times;i++)
//	{
...
//
//	btree::btree_map<int,double>::iterator it_update;
...
//	btree::btree_map<int,AudioInfo>::iterator it_audio;
//	while(count<times)
//	{
